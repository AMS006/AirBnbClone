  ...
  return (
    <div className='grid gap-2 md:grid-cols-[2fr_1fr_1fr] sm:grid-cols-[2fr_1fr] my-4 relative'>
        <div className='h-full w-full cursor-pointer' onClick={() => setOpen(true)} >
          <img src={`http://localhost:4000/uploads/${photos[0]}`} className='object-cover rounded-lg h-full w-full cursor-pointer' alt="" />
        </div>
        <div className='sm:grid hidden grid-rows-2 gap-2 h-full w-full cursor-pointer'>
          <div className='h-full w-full cursor-pointer' onClick={() => setOpen(true)}>
            <img src={`http://localhost:4000/uploads/${photos[1]}`} alt="" className='object-cover rounded-lg h-full w-full cursor-pointer' />
          </div>
          <div className='h-ful w-full'>
            <img src={`http://localhost:4000/uploads/${photos[2]}`} alt="" className='object-cover rounded-lg h-full w-full cursor-pointer' />
          </div>
        </div>
        <div className='md:grid hidden grid-rows-2 gap-2 h-full w-full cursor-pointer'>
          <div className='h-full w-full cursor-pointer' onClick={() => setOpen(true)}>
            <img src={`http://localhost:4000/uploads/${photos[3]}`} alt="" className='object-cover rounded-lg h-full w-full cursor-pointer' />
          </div>
          <div className='h-full w-full cursor-pointer' onClick={() => setOpen(true)}>
            <img src={`http://localhost:4000/uploads/${photos[4]}`} alt="" className='object-cover rounded-lg h-full w-full cursor-pointer' />
          </div>
        </div>
