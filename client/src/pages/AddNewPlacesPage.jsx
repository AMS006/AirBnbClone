    ...
    <div className='mt-4 px-6'>
        ...
        <form className='my-4 flex flex-col gap-3' onSubmit={handleSubmit}>
            <div className='flex flex-col '>
                ...
                <input type="text" name="" className='w-full border border-gray-600 rounded-xl px-4 py-2' id="title" placeholder='title, for example: My lovely apt' value={title} onChange = {(e) => setTitle(e.target.value)} />
            </div>
            <div className='flex flex-col '>
                ...
                <input type="text" name="" className='w-full border border-gray-600 rounded-xl px-4 py-2' id="address" placeholder='address' value={address} onChange = {(e) => setAddress(e.target.value)}/>
            </div>
            <div className='flex flex-col '>
            ...
            <div className='flex flex-col '>
                ...
                <textarea rows={5} name="" className='w-full border border-gray-600 rounded-xl px-4 py-2' id="description" placeholder='Add description' value={description} onChange = {(e) => setDescription(e.target.value)}/>
            </div>
            <div className='flex flex-col '>
            ...
            <div className='flex flex-col '>
                ...
                <div className='flex items-center gap-3 mt-2'>
                    <div>
                        ...
                        <input type="time" name="" className='w-full border border-gray-600 rounded-xl px-4 py-2' id="checkIn" placeholder='address' value={checkIn} onChange = {(e) => setCheckIn(e.target.value)}/>
                    </div>
                    <div>
                        <label htmlFor="checkOut" className='font-semibold'>CheckOut Time</label>
                        <input type="time" name="" className='w-full border border-gray-600 rounded-xl px-4 py-2' id="checkOut" placeholder='address' value={checkOut} onChange = {(e) => setCheckOut(e.target.value)}/>
                    </div>
                </div>
            </div>
            <div className='flex flex-col'>
                ...
                <input type="Number" name="" className='w-full border border-gray-600 rounded-xl px-4 py-2' id="guests" placeholder='Number of guests' value={maxGuests} onChange = {(e) => setMaxGuests(e.target.value)}/>
            </div>
            <div className='flex flex-col'>
                ...
                <input type="Number" name="" className='w-full border border-gray-600 rounded-xl px-4 py-2' id="price" placeholder='Price of place' value={price} onChange = {(e) => setPrice(e.target.value)}/>
            </div>
